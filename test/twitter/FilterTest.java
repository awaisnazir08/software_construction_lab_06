...
public class FilterTest {
    ...
    @Test
    public void testWrittenByUserNotFound() {
    ...
    @Test
    public void testInTimespanOutsideRange() {
    ...
    public void testContainingMultipleWords() {
        List<Tweet> containing = Filter.containing(Arrays.asList(tweet1, tweet2), Arrays.asList("talk", "hype"));
